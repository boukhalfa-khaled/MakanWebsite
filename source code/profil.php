...
if (isset($_SESSION['user-id'])) {
    ...
    echo $id;
    $post_query = "SELECT * FROM posts, wilay, users WHERE posts.user_id = $id AND posts.user_id = users.id AND posts.wilay_id = wilay.w_id    ORDER BY posts.data_time DESC ";
        ...
        <div class="posts-parent">
            <?php while ($post = mysqli_fetch_assoc($posts)) : ?>
                <div class="post  type-all type-rent">
                    ...
                    <a href="<?= ROOT ?>delete-post.php?id=<?= $post['post_id'] ?>">
                        <div class="delete">
                            احذف المنشور
                        </div>
                    </a>
